...
// ── Generic standard config (shared by every category) ───────────────────────
// All categories share one identical "add item" page. Category-specific
// properties are added by admins via custom fields, not hard-coded here.
...
export const DEFAULT_FIELD_CONFIGS: Record<string, CategoryFieldConfig> = {
  fans:   GENERIC_FIELD_CONFIG,
  lights: GENERIC_FIELD_CONFIG,
  wires:  GENERIC_FIELD_CONFIG,
};
